...
NAME: Final = "OBD Drive"
DOMAIN: Final = "obd_drive"

# Garde-fous (options)
CONF_REJECT_POOR_NAME = "reject_poor_name"
CONF_REQUIRE_MAPPED_NAME = "require_mapped_name"
DEFAULT_REJECT_POOR_NAME = True
DEFAULT_REQUIRE_MAPPED_NAME = False
...
SUPPORTED_LANGS: Final = {"fr": "Français", "en": "English"}
RUNTIME_LANG_MAP: Final = {"fr": "fr", "fr-fr": "fr", "en": "en", "en-us": "en", "en-gb": "en"}

# Sessions
SESSION_TTL_SECONDS: Final = 900
MAX_SESSIONS: Final = 256
...
CONF_MERGE_NAME_MAP: Final = "merge_name_map"
MERGE_MODE_NONE: Final = "none"
MERGE_MODE_NAME: Final = "name"
MERGE_MODE_VIN: Final = "vin"
DEFAULT_MERGE_MODE: Final = MERGE_MODE_NONE
DEFAULT_MERGE_NAME_MAP: Final = ""

# Entités GPS (shortNames normalisés utilisés partout)
ENTITY_GPS: Final = "gps"
OBD_GPS_LAT: Final = "gpslat"
OBD_GPS_LON: Final = "gpslon"
OBD_GPS_ALTITUDE: Final = "gpsalt"
OBD_GPS_ACCURACY: Final = "gpsaccuracy"

# Table des PIDs -> shortName / libellé / unité
OBD_CODES: Final = {
    # --- Mode 01 classiques ---
    ...
    # --- Extensions Torque / GPS / dérivés ---
    "ff1001": {"shortName": "speed_gps", "fullName": "Vehicle Speed (GPS)", "unit": "km/h"},     # <- cohérent
    "ff1005": {"shortName": OBD_GPS_LON, "fullName": "GPS Longitude", "unit": "°"},
    "ff1006": {"shortName": OBD_GPS_LAT, "fullName": "GPS Latitude", "unit": "°"},
    "ff1010": {"shortName": OBD_GPS_ALTITUDE, "fullName": "GPS Altitude", "unit": "m"},
    ...
    "ff1239": {"shortName": OBD_GPS_ACCURACY, "fullName": "GPS Accuracy", "unit": "m"},
