# -*- coding: utf-8 -*-
"""Base entity for the OBD Drive integration.
...
- dynamically name the Device from the latest OBD profile (Name/version)
...
class OBDEntity(CoordinatorEntity):
    """Base class binding an entity to a OBD vehicle and coordinator."""
    ...
    def __init__(
        ...
        *,
        ...
        if self._car_id == "unknown":
            _LOGGER.warning(
                "OBDEntity created with unknown car_id (sensor_key=%s)", self._sensor_key
            )
    ...
    async def async_added_to_hass(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("OBDEntity unique_id migration failed")
